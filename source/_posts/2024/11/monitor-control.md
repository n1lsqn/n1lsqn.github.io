---
title: 特定のプログラムを起動したらモニターの接続を解除してパフォーマンスを改善する方法
...
最近VR機器を使うことが増えてきており、マルチモニター環境においてSteamVRやVRChat等のVRゲームを起動したときに、モニターの接続を解除してあげるとFPSが自環境では5-10FPSの工場が見られたので備忘録。
...
:: monitor IDs
set "MAIN_MONITOR_ID=MONITOR\PHLC208\{4d36e96e-e325-11ce-bfc1-08002be10318}\0001"
set "SUB1_MONITOR_ID=MONITOR\ACR0758\{4d36e96e-e325-11ce-bfc1-08002be10318}\0007"
set "SUB2_MONITOR_ID=MONITOR\BNQ78CE\{4d36e96e-e325-11ce-bfc1-08002be10318}\0002"
...
またahkファイルを開いてシステムトレイに追加されてたらok。緑でHと書いてあるロゴ
